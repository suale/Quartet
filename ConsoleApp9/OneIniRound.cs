...
namespace ConsoleApp9
{
    class OneIniRound
    {
        ...
        public List<BitArray> OneIniRoundImplemen(List<BitArray> gelenBitArrayler)
        {
            ...
            BitArray x3 = tauFunction.TauFuncImplement(lambdaFunction.LambdaFuncImplement(roFunction.RoFunctionImplement(xFunction.XfunctionImplement(gelenBitArrayler[0], gelenBitArrayler[1], gelenBitArrayler[2]), sabit2), param3[0], param3[1]));
